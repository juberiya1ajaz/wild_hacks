...
import PredictionResult from '../components/PredictionResultTreatment'
        ...
        <div>
            {file.name ? (
                ...
                <div className="grid place-items-center">
                    ...
                    <h1 className="py-5 text-5xl font-bold text-white">Find treatment for injured animals.</h1>
